...
<body>
	<div class="container mt-4">
		...
		<div class="row justify-content-center">
			<div class="col-8">
				<form:form action="/projects/new" method="post" class="border p-4"
					...
					<div class="row mb-4">
						<form:label path="dueDate" class="col-sm-4 col-form-label">My Thoughts: </form:label>
						<div class="col-sm-8">
					...
					<div class="row justify-content-end">
						...
						<div class="col-sm-3">
							<button type="submit" class="btn btn-warning ms-4">Add Project</button>
						</div>
					</div>
				</form:form>
			</div>
