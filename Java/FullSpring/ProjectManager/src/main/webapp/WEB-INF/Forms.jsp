	...
	<div class="container-sm mt-3">
        <div class="row justify-content-center">
            <div class="col-md-6" style="text-align: center;">
            	<h2 style="color: blue;">Project Manager</h2>
        ...
        <div class="row justify-content-center">
            ...
            <h3>Register</h3>
                <form:form action="/register" method="post" modelAttribute="newUser">
                    ...
                    <form:input path="firstName" type="text" class="form-control mt-4" placeholder="User name" />
					<form:errors path="firstName" style="color:red;"/>
					
                    <form:input path="lastName" type="text" class="form-control mt-4" placeholder="User name" />
